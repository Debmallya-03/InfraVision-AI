              ...
              <div className="left-content fade-in-left">
                <div className="text-center mb-4">
                  ...
                  >
                    ...
                    ></div>
                    <p className="brand-tagline m-0 fade-in delay-1">
                      Scan. Detect. Prevent
                    </p>
                    <div
                      style={{
                  ...
                  <p
                    className="text-white mb-4 fade-in delay-2"
              ...
              <div className="login-card p-4 p-lg-5 fade-in-right">
                <div className="login-header">
                  ...
                  <p className="text-white mb-0">
                    Sign in to your InfraVision account
                  </p>
                </div>

                <form onSubmit={handleSubmit} className="fade-in-up delay-1">
                  <div className="mb-4">
                ...
                <div className="divider fade-in-up delay-2">
                  <span>Or continue with</span>
                </div>

                <div className="social-login mb-4 fade-in-up delay-3">
                ...
                <div className="signuplink">Don't have an account? <a href="/landing_page/SignUp" >Sign Up</a></div>

                <div className="text-center fade-in-up delay-4"></div>
              </div>
            </div>
          </div>
        </div>
